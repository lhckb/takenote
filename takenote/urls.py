...
urlpatterns = [
    ...
    path('account/update/username', views.submitUsernameUpdate),
    path('account/update/password', views.submitPasswordUpdate),
    path('account/delete/<username>', views.deleteAccount),
    path('', views.index),
